...
<div class="modal fade" id="modalExcluir" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalExcluir" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="was-validated form-container" action="include/eEntradaProdutoEstoque.php" method="post">
                <input type="text" name="id_entrada-item-estoque" id="id_entrada-item-estoque" value="<?php echo $id ?>" hidden>
